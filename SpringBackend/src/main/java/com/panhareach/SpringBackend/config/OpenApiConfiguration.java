package com.panhareach.SpringBackend.config;
...
public class OpenApiConfiguration {
    ...
    public GroupedOpenApi backendGroup() {
        return GroupedOpenApi.builder().group("backend-api").addOpenApiCustomizer(openApi -> openApi.info(getBackendApiInfo())).packagesToScan("com.panhareach.SpringBackend.controller.backend").build();
    }
